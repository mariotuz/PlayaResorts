 ...
 <script type="text/javascript">
     ...
     $(document).ready(function () {
         ...
         document.getElementById("date").innerHTML = d.toDateString();
                        ...
                        <p>Payment Status:
                            <select class="select-status"  name="selectstatuspayment" id="selectstatuspayment">
                        ...
                        <p>Book Status:
                            <select class="select-status" name="selectstatusbook" id="selectstatusbook">
                         ...
                         <p>Hotel Status
                            <select class="select-status" name="selectstatushotel" id="selectstatushotel" >
