...
<br>
<div>
<% If (ViewData("idseccion1subseccion6new_permission") IsNot Nothing And ViewData("idseccion1subseccion6new_permission") > 0) Then
%>
...
<input type="text" id="cve_hoteltxt" name="Cve_Hotel" hidden value="<%:Model.EditGroupData1%>">
