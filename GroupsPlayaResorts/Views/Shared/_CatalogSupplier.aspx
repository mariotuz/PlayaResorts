...
<% Using Ajax.BeginForm("CatalogSupplier", "Catalogs", New AjaxOptions With {.OnBegin = "OnBegin", .OnComplete = "OnComplete", .OnSuccess = "OnSuccessEdit", .OnFailure = "OnFailureEdit", .UpdateTargetId = "AJAX_Container1"}, New With {.id="FormSupplierEdit"})%>
