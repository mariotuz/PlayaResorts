...
(function(b) {
    ...
    b.fn.uploadFile = function(f) {
        var p = b.extend({
            ...
            dragDropStr: "<span> <p> Drag &amp; Drop Files</p></span>",
            abortStr: "Abort",
            cancelStr: "Cancel",
            deletelStr: "Delete",
            doneStr: "Done",
        ...
        (function l() {
            if (b.fn.ajaxForm) {
                if (p.dragDrop) {
                    var s = b('<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 ' + p.dragDropContainerClass + '" style="vertical-align:top; border: 2px dotted rgb(165, 165, 199);"></div>').width(p.dragdropWidth);
                    b(n).before(s);
                    b(s).append(q);
        ...
        function j(y, x) {
            this.statusbar = b("<div class='col-xs-12 col-sm-12 col-md-4 col-lg-4 ajax-file-upload-statusbar'></div>").width(x.statusBarWidth);
